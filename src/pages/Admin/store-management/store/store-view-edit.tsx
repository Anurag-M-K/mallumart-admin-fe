...
import WrappedSelect, { WrappedCheckbox, WrappedFileUpload, WrappedInputForUniqueName, WrappedToggleButton, wrapidQuill } from '../../../../components/wrappedComponents/wrappedComponent';
...
function StoreViewEdit() {
    ...
    const onSubmit = async (values: TStoreValues) => {
        ...
        try {
            setLoading(true);
            const response: any = await updateStore(adminDetails?.token, changedFields);
            const res:any = await fetchAllStore(adminDetails?.token)
                            ...
                            <div className="col-span-6">
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex border-none text-white-dark">
                                        ...
                                        <Field initialValue={singleStore[0].wholeSale} id="wholeSale" type="checkbox" className="placeholder:text-white-dark" name="wholeSale" label="Whole sale" component={WrappedCheckbox} />
                                        <Field initialValue={singleStore[0].retail} id="retail" type="checkbox" label="Retail" component={WrappedCheckbox} className="placeholder:text-white-dark" name="retail" />
                                    </div>
                                </div>
                            </div>
                            <div className="col-span-6">
