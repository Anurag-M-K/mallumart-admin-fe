...
import { addAdvertisement } from '../../../api/storeApi';
import { setAdvertisementDetails } from '../../../store/advertisementSlice';
import { fetchAllAdvertisement } from '../../../api/adminApi';
...
function AddAdvertisement({ handleCancel, id, editDefaultValues }: { handleCancel: () => void; id: string; editDefaultValues: any }) {
    ...
    const onSubmit = handleSubmit(async (values: any) => {
        try {
            ...
            const response: any = await addAdvertisement(storeOwnerToken, values);
            const advertisementData:any = await fetchAllAdvertisement(storeOwnerToken)
