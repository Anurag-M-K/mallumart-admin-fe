...
import { password_check, validation_required } from '../../utils/validation';
                ...
                <div className="relative bg-white flex w-full items-center  px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">MALLU STORE</span>
                        </Link>
                        <button
                            type="button"
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown offset={[0, 8]} placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`} btnClassName="relative group block" button={<RiAdminFill size={24} />}>
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            <div className="ltr:pl-4 rtl:pr-4 truncate">
                                                <h4 className="text-base">Staff</h4>
                                                <button type="button" className="text-black/60 cursor-none dark:text-dark-light/60 dark:hover:text-white">
                                    ...
                                    <li onClick={handleLogout} className="border-t cursor-pointer hover:bg-blue-100 border-white-light dark:border-white-light/10">
                                                    ...
                                                    <form onSubmit={handleSubmit}>
                                                        ...
                                                        <div className="my-4">
                                                            ...
                                                            <div className="relative text-white-dark">
                                                                ...
                                                                {res?.response?.status != 200 && <span className="text-red-500 mt-5">{res?.response?.data?.message}</span>  } 
                                                        </div>
